...
describe 'Usuário vê seus próprios pedidos' do
  ...
  it 'e vê itens de um pedido' do
    ...
    product_c = ProductModel.create!(
      name: 'Produto C', weight: 1, width: 10, height: 15,
      depth: 10, supplier:, sku: 'sku-c123456789123456'
    )
    ...
    OrderItem.create!(product_model: product_a, order:, quantity: 12)
    OrderItem.create!(product_model: product_b, order:, quantity: 21)
    ...
    expect(page).to have_content('21 x Produto B')
  end
end
